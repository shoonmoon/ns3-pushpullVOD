...
NS_LOG_COMPONENT_DEFINE ("pushpull::RequestSchedulingStrategyBase");
NS_OBJECT_ENSURE_REGISTERED (RequestSchedulingStrategyBase);


RequestSchedulingStrategyBase::RequestSchedulingStrategyBase (Ptr<PushPullClient> myClient) : AbstractStrategy (myClient)
{
