...
namespace ns3 {
namespace pushpull {
NS_LOG_COMPONENT_DEFINE ("pushpull::PushPullVideoClient");
NS_OBJECT_ENSURE_REGISTERED (PushPullVideoClient);

PushPullVideoClient::PushPullVideoClient ()
{
  ...
  m_piecesMissable = true; 
  // for collecting missed rate;
...
TypeId PushPullVideoClient::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PushPullVideoClient")
    .SetParent<PushPullClient> ()
    .AddConstructor<PushPullVideoClient> ()
  ;
  return tid;
}

void PushPullVideoClient::StopApplication ()
{
  PushPullClient::StopApplication ();
}

void PushPullVideoClient::StartApplication ()
{
  // Step 1: Initialize the underyling PushPull client, also intializing the used protocol
  PushPullClient::StartApplication ();
  ...
  if (comment.size () > 0)
  ...
  else
    {
      ...
      // NS_LOG_WARN ("Warning: PushPullVideoClient could not figure out length and fps of video to be downloaded.");
    }
...
Time PushPullVideoClient::GetTotalLength () const
{
 return m_totalLength;
}

Time PushPullVideoClient::GetPlaybackPosition () const
{
  return m_playbackPosition;
}

Time PushPullVideoClient::GetPreBufferingTime () const
{
  return m_preBufferingTime;
}

void PushPullVideoClient::SetPreBufferingTime (Time preBufferingTime)
{
...
bool PushPullVideoClient::GetAutoPlay () const
{
  return m_autoPlay;
}

void PushPullVideoClient::SetAutoPlay (bool autoPlay)
{
  m_autoPlay = autoPlay;
}

bool PushPullVideoClient::GetAutoPlayFromRight () const
{
 return m_autoPlayFromRight;
}

void PushPullVideoClient::SetAutoPlayFromRight (bool autoPlayFromRight)
{
 m_autoPlayFromRight = autoPlayFromRight;
}

bool PushPullVideoClient::GetPiecesMissable () const
{
  return m_piecesMissable;
}

void PushPullVideoClient::SetPiecesMissable (bool piecesMissable)
{
  m_piecesMissable = piecesMissable;
}

Time PushPullVideoClient::GetSkipTolerance () const
{
  return m_skipTolerance;
}

void PushPullVideoClient::SetSkipTolerance (Time skipTolerance)
{
...
Time PushPullVideoClient::GetRequiredContinousPlaybackAfterSkip () const
{
  return m_continousPlaybackAfterSkip;
}

void PushPullVideoClient::SetRequiredContinousPlaybackAfterSkip (Time continousPlaybackAfterSkip)
{
...
uint32_t PushPullVideoClient::GetCurrentPiece () const
{
  return TimeToPiece (m_playbackPosition);
}

bool PushPullVideoClient::IsPlaying () const
{
  return m_playing;
}

bool  PushPullVideoClient::IsPaused () const
{
  return m_paused;
}

Time PushPullVideoClient::GetRemainingPause () const
{
...
uint32_t PushPullVideoClient::GetContinousPiecesFromPiece (uint32_t piece) const
{
  uint32_t result = 0;
  ...
  uint32_t currentBitfieldIndex = piece / (PP_PROTOCOL_PULL_WINDOW + PP_PROTOCOL_PUSH_WINDOW);

  // Step 1: Go through the probably only partially filled bitfield entry containing this piece
  uint(PP_PROTOCOL_PULL_WINDOW + PP_PROTOCOL_PUSH_WINDOW)_t currentPiece = m_bitfield[currentBitfieldIndex];
  currentPiece >>= piece % (PP_PROTOCOL_PULL_WINDOW + PP_PROTOCOL_PUSH_WINDOW);       // Shift index of the requested piece to the beginning of currentPiece for easier counting (big endian!)
  ...
  if (result != ((PP_PROTOCOL_PULL_WINDOW + PP_PROTOCOL_PUSH_WINDOW) - piece % (PP_PROTOCOL_PULL_WINDOW + PP_PROTOCOL_PUSH_WINDOW)))
    {
      return result;
    }
  ...
  if (currentBitfieldIndex < GetTorrent ()->GetBitfieldSize () - 1)
    {
      for (; currentBitfieldIndex < GetTorrent ()->GetBitfieldSize () - 1 && m_bitfield[currentBitfieldIndex] == 0xFF; )
        {
          result += (PP_PROTOCOL_PULL_WINDOW + PP_PROTOCOL_PUSH_WINDOW);
          ++currentBitfieldIndex;
        }
    }
...
uint32_t PushPullVideoClient::GetContinousMissingPiecesFromPiece (uint32_t piece) const
{
...
Time PushPullVideoClient::GetTimeUntilPiece (uint32_t piece) const
{
...
void PushPullVideoClient::Pause ()
{
...
void PushPullVideoClient::UnPause ()
{
  if (m_playing && !m_buffering)      // Users shall not interfere with the buffering of the application - at least not by unpausing it.
    {
...
void PushPullVideoClient::SetPlaybackPosition (Time position)
{
...
void PushPullVideoClient::SetPlaybackPositionRelative (Time change)
{
...
void PushPullVideoClient::SetPlaybackPositionToTheRight (bool keepPreBufferingPhase)
{
...
void PushPullVideoClient::BufferFor (Time bufferingPeriod)
{
  if (!m_playing)
    {
  ...
  m_nextBufferForElapsedEvent = Simulator::Schedule (bufferingPeriod, &PushPullVideoClient::UnPauseAfterBuffering, this);
  m_pausedUntil = Simulator::Now () + bufferingPeriod;
}

void PushPullVideoClient::BufferNext (Time period)
{
  BufferUntil (m_playbackPosition + period);
}

void PushPullVideoClient::BufferUntil (Time position)
{
  if (position > m_totalLength)
    {
  ...
  if (GetContinousPiecesFromPiece (TimeToPiece (m_playbackPosition)) < TimeToPiece (position) - TimeToPiece (m_playbackPosition) + 1)
    {
      ...
      m_nextBufferCheckEvent = Simulator::Schedule (MilliSeconds (m_milliSecondsPerPiece), &PushPullVideoClient::BufferUntil, this, position);
      m_pausedUntil = Simulator::Now () + m_totalLength;
    }
  else
    {
...
void PushPullVideoClient::BufferRange (uint32_t rangeStart, uint32_t rangeEnd)
{
  ...
  if (GetContinousPiecesFromPiece (rangeStart) < rangeEnd - rangeStart)
    {
      ...
      // Step 1c: Schedule the regular check for the appearance of the needed pieces
      m_nextBufferCheckEvent = Simulator::Schedule (MilliSeconds (m_milliSecondsPerPiece), &PushPullVideoClient::BufferRange, this, rangeStart, rangeEnd);
      m_pausedUntil = Simulator::Now () + m_totalLength;
    }
  else
    {
...
Time PushPullVideoClient::PieceToTime (uint32_t piece) const
{
  return MilliSeconds (static_cast<uint64_t> (ceil (piece * m_milliSecondsPerPiece)));
}

uint32_t PushPullVideoClient::TimeToPiece (Time time) const
{
  return floor (time.GetMilliSeconds () / m_milliSecondsPerPiece);
}

void PushPullVideoClient::PlaybackStateChangedEvent ()
{
...
void PushPullVideoClient::PlaybackPositionChangedEvent ()
{
...
void PushPullVideoClient::PlaybackPositionWillChangePeriodicallyEvent ()
{
...
void PushPullVideoClient::CannotAdvancePlaybackEvent ()
{
...
void PushPullVideoClient::SkippedPiecesInPlaybackEvent (uint32_t oldPiece, uint32_t newPiece)
{
...
void PushPullVideoClient::PlaybackFinishedEvent ()
{
...
void PushPullVideoClient::RegisterCallbackPlaybackStateChangedEvent (Callback<void> eventCallback)
{
  m_playbackStateChangedEventListeners.push_back (eventCallback);
}

void PushPullVideoClient::UnregisterCallbackPlaybackStateChangedEvent (Callback<void> eventCallback)
{
  std::list<Callback<void> >::iterator iter = m_playbackStateChangedEventListeners.begin ();
  for (; iter != m_playbackStateChangedEventListeners.end (); ++iter)
    {
...
void PushPullVideoClient::RegisterCallbackPlaybackPositionChangedEvent (Callback<void, Time> eventCallback)
{
  m_playbackPositionChangedEventListeners.push_back (eventCallback);
}

void PushPullVideoClient::UnregisterCallbackPlaybackPositionChangedEvent (Callback<void, Time> eventCallback)
{
  std::list<Callback<void, Time> >::iterator iter = m_playbackPositionChangedEventListeners.begin ();
  for (; iter != m_playbackPositionChangedEventListeners.end (); ++iter)
    {
...
void PushPullVideoClient::RegisterCallbackPlaybackPositionWillChangePeriodicallyEvent (Callback<void> eventCallback)
{
  m_playbackStateWillChangePeriodicallyEventListeners.push_back (eventCallback);
}

void PushPullVideoClient::UnregisterCallbackPlaybackPositionWillChangePeriodicallyEvent (Callback<void> eventCallback)
{
  std::list<Callback<void> >::iterator iter = m_playbackStateWillChangePeriodicallyEventListeners.begin ();
  for (; iter != m_playbackStateWillChangePeriodicallyEventListeners.end (); ++iter)
    {
...
void PushPullVideoClient::RegisterCallbackCannotAdvancePlaybackEvent (Callback<void> eventCallback)
{
  m_CannotAdvancePlaybackEventListeners.push_back (eventCallback);
}

void PushPullVideoClient::UnregisterCallbackCannotAdvancePlaybackEvent (Callback<void> eventCallback)
{
  std::list<Callback<void> >::iterator iter = m_CannotAdvancePlaybackEventListeners.begin ();
  for (; iter != m_CannotAdvancePlaybackEventListeners.end (); ++iter)
    {
...
void PushPullVideoClient::RegisterCallbackSkippedPiecesInPlaybackEvent (Callback<void, uint32_t, uint32_t > eventCallback)
{
  m_skippedPiecesInPlaybackEventListeners.push_back (eventCallback);
}

void PushPullVideoClient::UnregisterCallbackSkippedPiecesInPlaybackEvent (Callback<void, uint32_t, uint32_t > eventCallback)
{
  std::list<Callback<void, uint32_t, uint32_t> >::iterator iter = m_skippedPiecesInPlaybackEventListeners.begin ();
  for (; iter != m_skippedPiecesInPlaybackEventListeners.end (); ++iter)
    {
...
void PushPullVideoClient::RegisterCallbackPlaybackFinishedEvent (Callback<void> eventCallback)
{
  m_playbackFinishedEventListeners.push_back (eventCallback);
}

void PushPullVideoClient::UnregisterCallbackPlaybackFinishedEvent (Callback<void> eventCallback)
{
  std::list<Callback<void> >::iterator iter = m_playbackFinishedEventListeners.begin ();
  for (; iter != m_playbackFinishedEventListeners.end (); ++iter)
    {
...
void PushPullVideoClient::UnPauseAfterBuffering ()
{
  if (m_playing)
    {
...
void PushPullVideoClient::AdvancePlayback ()
{
                  ...
                  if (PieceToTime (piecesAfterwards) >= m_continousPlaybackAfterSkip)
                    {
                      ...
                      m_nextAdvancePlaybackEvent = Simulator::Schedule (MilliSeconds (m_milliSecondsPerPiece), &PushPullVideoClient::AdvancePlayback, this);
                    }
