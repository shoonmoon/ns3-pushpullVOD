...
#ifndef PUSHPULLVIDEOCLIENT_H_
#define PUSHPULLVIDEOCLIENT_H_
 ...
 * \ingroup PushPull
 *
 * \brief A PushPull Video-on-Demand client application for ns-3.
 *
 * This class provides a Video-on-Demand simulation model based on the PushPull model provided by the PushPullClient class.
 ...
 */
class PushPullVideoClient : public PushPullClient
{
// Fields
private:
...
public:
   ...
   *
   * A call to this method initializes the Video-on-Demand client. The initializer of the parent PushPullClient class is called and then
