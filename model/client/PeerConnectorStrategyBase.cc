...
NS_LOG_COMPONENT_DEFINE ("pushpull::PeerConnectorStrategyBase");
NS_OBJECT_ENSURE_REGISTERED (PeerConnectorStrategyBase);

PeerConnectorStrategyBase::PeerConnectorStrategyBase (Ptr<PushPullClient> myClient) : AbstractStrategy (myClient)
{
