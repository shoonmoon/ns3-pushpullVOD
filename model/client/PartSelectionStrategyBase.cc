...
NS_LOG_COMPONENT_DEFINE ("pushpull::PartSelectionStrategyBase");

PartSelectionStrategyBase::PartSelectionStrategyBase (Ptr<PushPullClient> myClient) : AbstractStrategy (myClient)
{
   ...
   *
   * NOTE: For the sake of simplicity, this implementation will not store whether parts of a piece have been downloaded
