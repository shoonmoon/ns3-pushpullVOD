...
#ifndef PUSHPULLHTTPSERVER_H_
#define PUSHPULLHTTPSERVER_H_
 ...
 */
class PullPushHttpServer : public Object
{
// Fields
public:
  Ptr<Socket> m_socket;
...
public:
  PullPushHttpServer ();
  virtual ~PullPushHttpServer ();
private:
  PullPushHttpServer (const PullPushHttpServer&);
  PullPushHttpServer& operator = (const PullPushHttpServer);
